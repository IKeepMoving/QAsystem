            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">智能 题库</span>
                        <div class="description">你可以在这里看到你所生成的所有复习题</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
										  <s:if test="#request.listPair!=null">
										       <s:iterator var="qa_pair" value="#request.listPair" status="st">
                                            <tr class="active">
              
                                                <td><s:property value="#qa_pair.id"/></td>
                                                <td ><s:property value="#qa_pair.question"/></td>
												<td> <s:property value="#qa_pair.answer"/></td>
                                                <td> <s:a href="pair_viewUpdate?id=%{#qa_pair.id}">更新</s:a></td>
                                                <td> <s:a href="pair_delete?id=%{#qa_pair.id}">删除</s:a></td>
