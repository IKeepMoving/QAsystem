              ...
              <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">更新你的题库</span>
                        <div class="description">你可以在这里插入或者更新你的题库.</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <form method="post" action="${pageContext.request.contextPath }/pair_update">
                                          <s:hidden name="id" ></s:hidden>
                                            <s:textfield name="question" cssClass="form-control"/>                               
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">答案</label>
                                            <s:textfield name="answer" cssClass="form-control"></s:textfield>
                                        </div>
